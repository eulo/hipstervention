...
module.exports = Animate = (function() {
  Animate.prototype.data = {};

  Animate.prototype.loaded = false;

  Animate.prototype.playing = false;

  Animate.prototype.frame = null;
  ...
  Animate.prototype.load = function(callback) {
    ...
    if ($(window).width() <= 480) {
      if (this.$el.parent()[0].nodeName.toLowerCase() === 'h2') {
        this.noAni = true;
        this.img_src = this.img_src.replace('.png', '_still.png');
      } else {
  ...
  Animate.prototype.setup = function() {
    ...
    return this.keys = _.keys(this.data);
  };

  Animate.prototype.start = function() {
    var self;
    if (!this.loaded || this.playing || this.noAni) {
      return;
    }
    this.playing = true;
    self = this;
  ...
  Animate.prototype.mouseIn = function() {
    var self;
  ...
  Animate.prototype.mouseOut = function() {
    var self;
    if (!this.loaded) {
      return;
    }
  ...
  Animate.prototype.getFirst = function(obj) {
    var i;
    for (i in obj) {
  ...
  Animate.prototype.isInView = function() {
    var $window, docViewBottom, docViewTop, elemBottom, elemTop;
    $window = $(window);
...
},{"./../../bower_components/jquery/dist/jquery.js":1,"./../../bower_components/underscore/underscore.js":2,"./animate":3}]},{},[4])